        ...
        <el-row gutter=5>
          <el-col span=6 style="height: 500px;">
            <el-card style="height: 100%;">
              <div slot="header" class="clearfix" style="text-align: center; ">
                <span>今日评价</span>
                <el-checkbox @change="changeChosenPictures" v-model="pictures[0].checked"  class="card-checkbox"></el-checkbox>
              </div>
          ...
          <el-col span=10>
            <el-card style="margin-bottom: 10px;">
              <div slot="header" class="clearfix" style="text-align: center;">
                <span>涨跌预测</span>
                <el-checkbox v-model="pictures[1].checked" class="card-checkbox"></el-checkbox>
              </div>
              <div>
            ...
            <el-card>
              <div slot="header" class="clearfix" style="text-align: center;">
                <span>股价预测</span>
                <el-checkbox class="card-checkbox" @change="changeChosenPictures" v-model="pictures[2].checked"></el-checkbox>
              </div>
          ...
          <el-col span=8>
            <el-card>
              <div slot="header" class="clearfix" style="text-align: center;">
                <span>个股综合排名</span>
                <el-checkbox class="card-checkbox" v-model="pictures[3].checked"></el-checkbox>
              </div>
              <div>
                <el-tag>
                  行业内
      ...
      <el-table :data="historyData" style="width: 100%" border>
        ...
        <el-table-column  >
          <template slot="header" slot-scope="scope">
            <el-checkbox class="card-checkbox" @change="changeChosenPictures" v-model="pictures[4].checked"></el-checkbox>
          </template>
        </el-table-column>
      </el-table>


<!--        <el-tab-pane label="历史场景出现时刻" name="third-4-2">-->
<!--          <div style="text-align: center;">-->
<!--            <p>历史场景出现时刻：2020/11/08 相似度：<span style="color: red;">91.13%</span></p>-->
<!--          </div>-->
...
<!--                    资讯-->
<!--                  </el-tag>-->
<!--                  <el-checkbox class="card-checkbox"></el-checkbox>-->
<!--                </div>-->
<!--                <div>-->
<!--                  <el-table-->
<!--                    :data="newsData"-->
    ...
    <div v-show="cur==0">
      <div>
        ...
        <el-table :data="otherData" style="width: 100%" border>
          ...
          <el-table-column  >
            <template slot="header" slot-scope="scope">
              <el-checkbox class="card-checkbox" @change="changeChosenPictures" v-model="pictures[5].checked"></el-checkbox>
            </template>
          </el-table-column>
        </el-table>
        ...
        <el-table :data="otherData0" style="width: 100%" border>
          ...
          <el-table-column >
            <template slot="header" slot-scope="scope">
              <el-checkbox class="card-checkbox" @change="changeChosenPictures" v-model="pictures[6].checked"></el-checkbox>
            </template>
          </el-table-column>
        </el-table>
      </div>
